    ...
    <div class="container">
      ...
      <form  accept-charset="utf-8" method="get">
        <div class="form-group row">
          ...
          <div class="col-xl-6">
            <input class="btn btn-outline-secondary" id="radio1" name="rankAlgorithm" type="radio" <?php if($rankAlgorithm != "PageRank") { echo "checked='checked'"; } ?> value="lucene" /> 
              <label class="form-check-label" for="exampleRadios2">
                Lucene&nbsp;&nbsp;
              </label>
            <input class="btn btn-outline-secondary" id="radio2" name="rankAlgorithm" type="radio" <?php if($rankAlgorithm == "PageRank") { echo "checked='checked'"; } ?> value="PageRank" />
              <label class="form-check-label" for="exampleRadios2">
                PageRank&nbsp;&nbsp;
              </label>
...
if ($results)
{
  ...
  function getUrlFromCSV() {
    $resultArray = array();
    set_time_limit(1000);
    if (($handle = fopen("/home/shuming/solr-7.7.0/Reuters/URLtoHTML_reuters_news.csv", "r")) !== false) {
      while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        $fileId = $data[0];
        $fileUrl = $data[1];
        $fileId = "/home/shuming/solr-7.7.0/Reuters/reutersnews/reutersnews/".$fileId;
